...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"app/store/actions.js":[function(require,module,exports) {
"use strict";
...
exports.VisibilityFilters = exports.SET_VISIBILITY_FILTER = exports.DELETE_TODO = exports.TOGGLE_TODO = exports.ADD_TODO = void 0;
...
},{}],"app/store/reducers.js":[function(require,module,exports) {
"use strict";
...
var _default = store;
exports.default = _default;
},{"redux":"node_modules/redux/es/redux.js","./reducers":"app/store/reducers.js"}],"node_modules/lit-html/lib/directive.js":[function(require,module,exports) {
"use strict";
...
function Main(todos) {
  return (0, _litHtml.html)(_templateObject(), todos.map(function (todo, i) {
    return (0, _litHtml.html)(_templateObject2(), (0, _Todo.Todo)(todo, i));
  }));
}
},{"lit-html":"node_modules/lit-html/lit-html.js","./Todo":"app/components/Todo.js"}],"app/components/App.js":[function(require,module,exports) {
"use strict";
...
function App(state) {
  return (0, _litHtml.html)(_templateObject(), (0, _Header.Header)(), (0, _Main.Main)(state.todos));
}
},{"lit-html":"node_modules/lit-html/lit-html.js","./Header":"app/components/Header.js","./Main":"app/components/Main.js"}],"app/index.js":[function(require,module,exports) {
"use strict";
...
_store.default.subscribe(run);

run();
},{"./store/store":"app/store/store.js","./components/App":"app/components/App.js","lit-html":"node_modules/lit-html/lit-html.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
